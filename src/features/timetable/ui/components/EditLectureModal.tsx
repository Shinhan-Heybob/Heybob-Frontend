...
import { LectureUpdateRequest, Lecture } from '../../types';
...
export const EditLectureModal: React.FC<EditLectureModalProps & {timetableId: number}> = ({
  ...
  const [formData, setFormData] = useState<LectureUpdateRequest>({
    name: '',
    subjectCode: '',
    dayOfWeek: '월',
    startTime: '',
  ...
  const validateForm = (): boolean => {
    ...
    const validation = validateLectureData(formData, existingLectures, lecture.lectureId);
  ...
  const handleInputChange = (field: keyof LectureUpdateRequest, value: string) => {
    ...
    >
      ...
      >
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>강의 수정</Text>
